...
export class VariantService {
  static async createVariants(productId: string, variants: Omit<ProductVariant, 'id'>[]): Promise<void> {
    try {
  ...
  static async updateVariants(productId: string, variants: ProductVariant[]): Promise<void> {
    try {
