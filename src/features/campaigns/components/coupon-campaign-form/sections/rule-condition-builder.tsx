          ...
          <label className="text-sm font-medium">
            {
              t.campaigns.campaign.coupon.sections.advancedConditions.fields
                .ruleConditionBuilder.type.label
            }
          </label>
          <Select
          ...
          >
            <SelectTrigger className="bg-main">
              <SelectValue
                placeholder={
                  t.campaigns.campaign.coupon.sections.advancedConditions.fields
                    .ruleConditionBuilder.type.placeholder
                }
              />
            </SelectTrigger>
            <SelectContent>
                ...
                <div key={group.id}>
                  <div className="px-2 py-1.5 text-sm font-semibold text-muted-foreground">
                    {
                      t.campaigns.campaign.coupon.sections.advancedConditions
                        .fields.ruleConditionBuilder.type.groups[group.id]
                    }
                  </div>
                  {group.options.map((option) => (
                    <SelectItem key={option.value} value={option.value}>
                      {
                        t.campaigns.campaign.coupon.sections.advancedConditions
                          .fields.ruleConditionBuilder.type.options[
                          option.value
                        ]
                      }
                    </SelectItem>
          ...
          <>
            <div className="grid gap-2">
              <label className="text-sm font-medium">
                {
                  t.campaigns.campaign.coupon.sections.advancedConditions.fields
                    .ruleConditionBuilder.operator.label
                }
              </label>
              <Select
              ...
              >
                <SelectTrigger className="bg-main">
                  <SelectValue
                    placeholder={
                      t.campaigns.campaign.coupon.sections.advancedConditions
                        .fields.ruleConditionBuilder.operator.placeholder
                    }
                  />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="greater_than">
                    {
                      t.campaigns.campaign.coupon.sections.advancedConditions
                        .fields.ruleConditionBuilder.operator.options
                        .greaterThan
                    }
                  </SelectItem>
                  <SelectItem value="less_than">
                    {
                      t.campaigns.campaign.coupon.sections.advancedConditions
                        .fields.ruleConditionBuilder.operator.options.lessThan
                    }
                  </SelectItem>
                  <SelectItem value="equal_to">
                    {
                      t.campaigns.campaign.coupon.sections.advancedConditions
                        .fields.ruleConditionBuilder.operator.options.equalTo
                    }
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="grid gap-2">
              <label className="text-sm font-medium">
                {
                  t.campaigns.campaign.coupon.sections.advancedConditions.fields
                    .ruleConditionBuilder.value.label
                }
              </label>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="vip">
                      {
                        t.campaigns.campaign.coupon.sections.advancedConditions
                          .fields.ruleConditionBuilder.value.customerGroups.vip
                      }
                    </SelectItem>
                    <SelectItem value="wholesale">
                      {
                        t.campaigns.campaign.coupon.sections.advancedConditions
                          .fields.ruleConditionBuilder.value.customerGroups
                          .wholesale
                      }
                    </SelectItem>
                    <SelectItem value="new">
                      {
                        t.campaigns.campaign.coupon.sections.advancedConditions
                          .fields.ruleConditionBuilder.value.customerGroups.new
                      }
                    </SelectItem>
                  </SelectContent>
                </Select>
