export default {
  ...
  team: {
    ...
    freePlan: {
      ...
      limitWarning: "You're approaching your member limit. Consider upgrading your plan.",
      limitReached: "You've reached your member limit. Upgrade to add more members."
    },
    roles: {
      owner: 'Owner',
      admin: 'Admin',
    ...
    plan: {
      ...
      seatsAvailable: '{{count}} seats available',
      memberCount: '{{current}}/{{max}} members',
      upgradeNeeded: "You've reached your member limit. Upgrade to add more members.",
      approachingLimit: "You're approaching your member limit. Consider upgrading your plan.",
    },
    status: {
      active: 'Active',
      pending: 'Pending',
