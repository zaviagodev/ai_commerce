      ...
      productRules: {
        ...
        fields: {
          enabled: {
            ...
            description: 'Limit this campaign to specific products or categories'
          }
        }
      },
      earningRules: {
        ...
        advancedConditions: {
          ...
          fields: {
            advancedMode: {
              ...
              description: 'Create complex conditions for when this coupon can be used'
            },
            ruleBuilder: {
              operators: {
                and: 'AND',
        ...
        usageLimits: {
          ...
          fields: {
            totalLimit: {
              ...
              description: 'จำนวนครั้งสูงสุดที่คูปองนี้สามารถใช้ได้ (เว้นว่างไว้สำหรับไม่จำกัด)'
            },
            perCustomer: {
              label: 'จำกัดต่อลูกค้า',
              placeholder: 'ใส่จำนวนจำกัดต่อลูกค้า',
              description: 'จำนวนครั้งสูงสุดที่ลูกค้าแต่ละคนสามารถใช้คูปองนี้ได้'
            }
          }
        },
        advancedConditions: {
