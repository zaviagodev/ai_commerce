        ...
        automation: {
          ...
          fields: {
            autoAssign: {
              ...
              description:
                "Automatically add customers to this group when they match the conditions",
            },
            conditions: {
              label: "Conditions",
        ...
        pointsConfig: {
          ...
          fields: {
            multiplier: {
              ...
              description:
                "How many times the base points should be multiplied",
            },
            bonusPoints: {
              label: "Bonus Points",
        ...
        limitations: {
          ...
          fields: {
            ...
            userLimit: {
              ...
              description:
                "Maximum number of times each user can use this campaign",
            },
          },
        },
        displaySettings: {
        ...
        qrCodeConfig: {
          ...
          fields: {
            ...
            scanLimit: {
              ...
              description:
                "Maximum number of times each QR code can be scanned",
            },
          },
        },
        clickLinkConfig: {
    ...
    form: {
      ...
      fields: {
        ...
        verified: {
          ...
          description:
            "ทำเครื่องหมายลูกค้านี้เป็นลูกค้าที่ยืนยันแล้วด้วยเครื่องหมายถูก",
        },
      },
      errors: {
        ...
        automation: {
          ...
          fields: {
            autoAssign: {
              ...
              description:
                "เพิ่มลูกค้าเข้ากลุ่มโดยอัตโนมัติเมื่อตรงตามเงื่อนไข",
            },
            conditions: {
              label: "เงื่อนไข",
        ...
        basicDetails: {
          ...
          fields: {
            ...
            description: {
              ...
              description:
                "ให้รายละเอียดเกี่ยวกับวัตถุประสงค์และประโยชน์ของแคมเปญ",
            },
            startDate: {
        ...
        limitations: {
          ...
          fields: {
            ...
            userLimit: {
              ...
              description:
                "จำนวนครั้งสูงสุดที่ผู้ใช้แต่ละคนสามารถใช้แคมเปญนี้ได้",
            },
          },
        },
        displaySettings: {
