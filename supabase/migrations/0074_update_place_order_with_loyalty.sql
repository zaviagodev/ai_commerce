/*
# Update place_order function with loyalty points support

1. Changes
  - Remove p_discount parameter as it's not allowed from storefront
  - Add p_applied_coupons parameter
  - Add p_loyalty_points_used parameter
  - Add points_discount calculation
